package org.meowcat.ZipSigner.customkeys;
...
import org.meowcat.ZipSigner.AlertDialogUtil;
import org.meowcat.ZipSigner.R;
import org.meowcat.ZipSigner.filebrowser.AndroidFileBrowser;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        changeDirButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try
                {
                    Intent intent = new Intent("org.meowcat.ZipSigner.action.BROWSE_FILE");
